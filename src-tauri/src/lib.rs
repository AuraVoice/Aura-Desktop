...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            dictation::history::dictation_history_delete,
            dictation::history::dictation_history_clear,
            dictation::history::dictation_history_export_audio,
            ...
            dictation::command_brain::dictation_set_command_credential,
            dictation::command_brain::dictation_clear_command_credential,
