/** The Discord mark. Filled, so it sits at fill="currentColor" with no stroke;
 * the viewBox is cropped to the artwork's box so it matches lucide's optical
 * live area next to a 20px lucide glyph (see the icon rule in CLAUDE.md). */
